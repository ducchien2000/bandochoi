	...
	<table border="0" cellpadding="0" cellspacing="0" width="960" align="center" style="margin-top:20px; margin-bottom:20px; background:#FFFFFF;">
		<tr>
			<td height="40" style="color:#FFFFCC; background:#66A111;" colspan="2" align="center">
				ADMIN CONTROL PANEL - Web bán hàng ONLINE 
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<div class="menuleft">
					<a href="#" onclick="adm_chuyentrang('quanlyloaiqua')">Quản Lý Loại Đồ Chơi</a>
					<a href="#" onclick="adm_chuyentrang('quanlyqua')">Quản Lý Đồ Chơi</a>
			...
			background:#FFFFFF; color:#999999; text-align:left; border-right:none; border-left:none;">
					<span class="demuc"> Tổng Số Loại Đồ Chơi:</span> <?php echo $soloaiqua; ?>
					<br />
					<span class="demuc">Tổng Số Đồ Chơi:</span> <?php echo $soqua; ?>	
					<br />
			...
			<td width="760" valign="top">
					...
					if(isset($_POST['trangchuyen']))
					{
						...
						if($hienthi=='quanlyloaiqua')
							include_once('loaiqua/loaidochoi.php');
						else if($hienthi=='quanlyqua')
							include_once('qua/dochoi.php');
							...
							include_once('loaiqua/xl_loaidochoi.php');
						else if($hienthi=='xlqua')
							include_once('qua/xl_dochoi.php');
		...
		<tr>
			...
			Copyright © Nguyễn Đức Chiến. Công Nghệ Thông Tin - K19. 
			</td>
		</tr>
	</table>
